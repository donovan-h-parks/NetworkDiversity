...
#ifndef _UNWEIGHTED_UNIFRACA_
#define _UNWEIGHTED_UNIFRACA_
...
/**
 * @class Unweighted UniFrac
 * @brief Calculate the Unweighted UniFrac dissimilarity over a split system.
 */
class UnweightedUniFrac
{
public:
	UnweightedUniFrac() {}

	bool Run(const SplitSystem& splitSystem, Matrix& dissMatrix);
};
