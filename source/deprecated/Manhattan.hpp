...
/**
 * @class Manhattan
 * @brief Calculate the Manhattan dissimilarity over a split system.
 */
class Manhattan
{
public:
	...
	void RunPhylogenetic(const SplitSystem& splitSystem, Matrix& dissMatrix);
	void RunMatrix(SplitSystem& splitSystem, Matrix& dissMatrix);
